  ...
  function apply() {
    ...
    if (isDarkMode) {
      ...
      Object.assign(batch, {
        ...
        '--lc-on-surface-variant': '#a1a1b3',
        '--lc-surface-variant': '#232338',
        '--lc-outline-variant': '#3a3a4d',
      ...
      Object.assign(batch, {
        ...
        '--lc-on-surface-variant': '#6b7280',
        '--lc-surface-variant': '#f8f9fa',
        '--lc-outline-variant': '#e5e7eb',
