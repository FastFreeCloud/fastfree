...
export default defineConfig((ctx) => {
  return {
    boot: ['fastfree-auth-init', 'fastfree-accounting-init', 'fastfree-inventory-init', 'fastfree-hr-init', 'fastfree-crm-init', 'i18n', 'register-service-worker'],
    ...
    pwa: {
      ...
      manifest: {
        name: 'FastFree HR',
        short_name: 'FastFree',
        description: 'Human Resources + CRM System',
        display: 'standalone',
        ...
        shortcuts: [
          ...
          { name: 'About', url: '/about', description: 'About FastFree HR' },
        ],
      },
