...
export const services: Service[] = [
  {
    ...
    description_ar: 'محرك واجهات قابل لإعادة الاستخدام يوفّر مدير نوافذ وجداول CRUD وإنشاء نماذج ديناميكي وتصميماً ودعماً للعربية/الإنجليزية لبناء التطبيقات في وقت قياسي.',
    description_en: 'A reusable interface engine providing a window manager, CRUD tables, dynamic form generation, theming, and EN/AR i18n so business apps are built in record time.',
    icon: 'Blocks',
    features: [
  ...
  },
  {
    ...
    description_en: 'Multi-client deployment via NixOS + Docker with reverse proxy, private networking, backups, and a CLI tool.',
    icon: 'Cloud',
    features: [
      { ar: 'NixOS متعدد العملاء', en: 'NixOS Multi-Client' },
      { ar: 'Docker وشبكة خاصة', en: 'Docker + Private Network' },
  ...
  },
  {
    ...
    description_ar: 'تصميم وتطوير مواقع تعريفية ومتاجر إلكترونية سريعة ومتجاوبة ثنائية اللغة مع تحسين محركات البحث ولوحة تحكم سهلة.',
    description_en: 'Fast, responsive bilingual corporate sites and e-commerce stores with SEO and an easy-to-manage CMS.',
    icon: 'Globe',
    features: [
      { ar: 'مواقع تعريفية ومتاجر إلكترونية', en: 'Corporate Sites & E-commerce' },
      { ar: 'سرعة وتحسين محركات البحث', en: 'Performance & SEO' },
      { ar: 'دعم عربي/إنجليزي متجاوب', en: 'Responsive EN/AR Support' },
    ],
    is_active: true,
    sort_order: 11,
  },
  {
    id: '12',
    title_ar: 'تصميم الهوية والواجهات',
    title_en: 'Brand & UI/UX Design',
    description_ar: 'هوية بصرية وواجهات استخدام عصرية: شعارات وأدلة هوية وتصاميم واجهات جاهزة للتطوير.',
    description_en: 'Visual identity and modern UI/UX: logos, brand guidelines, and dev-ready interface designs.',
    icon: 'Palette',
    features: [
      { ar: 'هوية بصرية وشعارات', en: 'Logo & Brand Identity' },
      { ar: 'تصميم واجهات UI/UX', en: 'UI/UX Interface Design' },
      { ar: 'نماذج تفاعلية جاهزة', en: 'Dev-ready Prototypes' },
    ],
    is_active: true,
    sort_order: 12,
  },
