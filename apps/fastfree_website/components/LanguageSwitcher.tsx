...
export default function LanguageSwitcher() {
  ...
  return (
    ...
    >
      <Languages key={lang} size={14} aria-hidden="true" className="animate-fade-in-up transition-transform duration-300 group-hover:rotate-12" />
      <span key={lang} className="animate-fade-in-up inline-block min-w-[2ch] text-center">
        {lang === 'ar' ? 'EN' : 'AR'}
      </span>
    </button>
  );
