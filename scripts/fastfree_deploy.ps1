...
# 1. Push code
Write-Host "`n📤 Pushing code..." -ForegroundColor Yellow
git add -A
...
Write-Host "`n🔄 Triggering deploy workflow..." -ForegroundColor Yellow
...
# 5. Run diagnostic
Write-Host "`n🔍 Running diagnostic..." -ForegroundColor Yellow
